...
inline fix16_t fix16_sadd(fix16_t a, fix16_t b)
{
...
inline fix16_t fix16_ssub(fix16_t a, fix16_t b)
{
...
inline fix16_t fix16_smul(fix16_t inArg0, fix16_t inArg1)
{
...
inline fix16_t fix16_sdiv(fix16_t inArg0, fix16_t inArg1)
{
...
inline fix16_t fix16_mod(fix16_t x, fix16_t y)
{
...
inline fix16_t fix16_lerp8(fix16_t inArg0, fix16_t inArg1, uint8_t inFract)
{
...
inline fix16_t fix16_lerp16(fix16_t inArg0, fix16_t inArg1, uint16_t inFract)
{
...
inline fix16_t fix16_lerp32(fix16_t inArg0, fix16_t inArg1, uint32_t inFract)
{
	if(inFract == 0)
		return inArg0;
